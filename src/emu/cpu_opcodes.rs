...
impl Instruction {
  pub fn from_u8(value: u8) -> Instruction {
    return match value {
      ...
      0x11 => Instruction { opcode: Opcode::ORA, addr_mode: AddressingMode::IndirectY,     cycles: 5 },
      ...
      0xAC => Instruction { opcode: Opcode::LDY, addr_mode: AddressingMode::Absolute,     cycles: 4 },
